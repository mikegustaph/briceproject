...
@section('content')
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <a href="{{ URL::to('/create-target') }}" class="btn btn-sm fw-bold btn-primary">Add
                                        Target</a>
                                    <!--end::Primary button-->
                                </div>
                                <!--end::Actions-->
                                        ...
                                        <div class="card h-lg-100">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ count($customer) }}</span>
                                                    <!--end::Number-->
                                                    <!--begin::Follower-->
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Registered
                                                            Customer</span>
                                                    </div>
                                                    <!--end::Follower-->
                                                </div>
                                                ...
                                                @if ($customerpercent >= 0)
                                                    <span class="badge badge-light-success fs-base">
                                                        <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                        </i>{{ number_format($customerpercent, 1) }}%</span>
                                                    <!--end::Badge-->
                                                @else
                                        ...
                                        <div class="card h-lg-100">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $transaction }}</span>
                                                    <!--end::Number-->
                                                    <!--begin::Follower-->
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Success
                                                            Transactions</span>
                                                    </div>
                                                    <!--end::Follower-->
                                                </div>
                                                ...
                                                @if ($transPercent >= 0)
                                                    <span class="badge badge-light-success fs-base">
                                                        <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                        </i>{{ number_format($transPercent, 1) }}%</span>
                                                    <!--end::Badge-->
                                                @else
                                                    <span class="badge badge-light-danger fs-base">
                                                        <i class="ki-duotone ki-arrow-down fs-5 text-danger ms-n1">
                                        ...
                                        <div class="card h-lg-100">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $interest }}
                                                        <span class="fs-4 fw-semibold text-gray-500 me-1">TZS</span></span>
                                                    <!--end::Number-->
                                                    <!--begin::Follower-->
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Paid Interest</span>
                                                    </div>
                                                    <!--end::Follower-->
                                                </div>
                                                <!--end::Section-->
                                        ...
                                        <div class="card h-lg-100">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $repay }}
                                                        <span class="fs-4 fw-semibold text-gray-500 me-1">TZS</span></span>
                                                    <!--end::Number-->
                                                    <!--begin::Follower-->
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Repayments</span>
                                                    </div>
                                                    <!--end::Follower-->
                                                </div>
                                                <!--end::Section-->
                                    ...
                                    <div class="col-xl-8 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-xl-50 mb-5 mb-xl-10">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-wrap d-grid gap-5 px-9 mb-5">
                                                    ...
                                                    <div class="me-md-2">
                                                        ...
                                                        <div class="d-flex mb-2">
                                                            <span class="fs-4 fw-semibold text-gray-500 me-1">TZS</span>
                                                            <span
                                                                class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($target->amount, 0, '.', ',') }}</span>
                                                        </div>
                                                        <!--end::Statistics-->
                                                        <!--begin::Description-->
                                                        <span class="fs-6 fw-semibold text-gray-500">Targets for
                                                            {{ $target->target_month }}</span>
                                                        <!--end::Description-->
                                                    </div>
                                                    <!--end::Item-->
                                                    <!--begin::Item-->
                                                    ...
                                                    <div class="m-0">
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            <!--begin::Currency-->
                                                            <span
                                                                class="fs-4 fw-semibold text-gray-500 align-self-start me-1">TZS</span>
                                                            <!--end::Currency-->
                                                            <!--begin::Value-->
                                                            <span
                                                ...
                                                <!--end::Items-->
                                                <!--begin::Chart-->
                                                <div id="kt_charts_widget_20" data-series='@json($seriesData)'
                                                    data-categories='@json($categories)'
                                                    class="min-h-auto ps-4 pe-6" data-kt-chart-info="Revenue"
    ...
    <!--end::Modals-->
    @include('scripts._dashboard_script')
@endsection
