...
@section('content')
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Customer Profile</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            <a href="#"
                                                                class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ ucfirst($customer->first_name) }}
                                                                {{ ucfirst($customer->last_name) }}</a>
                                                            <a href="#">
                                                        ...
                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                            <a href="#"
                                                                ...
                                                                </i>{{ $customer->Occupation }}</a>
                                                            <a href="#"
                                                                class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                                                                <i class="ki-duotone ki-geolocation fs-4 me-1">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                                </i>{{ $customer->Address }}</a>
                                                            <a href="#"
                                                    ...
                                                    <div class="d-flex my-4">
                                                        ...
                                                        <a href="#" class="btn btn-sm btn-danger me-3"
                                                            ...
                                                            data-bs-target="#kt_modal_offer_a_deal">Suspend</a>
                                                        <!--begin::Menu-->
                                                        <div class="me-0">
                                                            <button
                                                        ...
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="fs-2 fw-bold" data-kt-countup="true"
                                                                        data-kt-countup-value="{{ $totalPrincipal }}"
                                                                        data-kt-countup-prefix="TZS ">0</div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="fs-2 fw-bold" data-kt-countup="true"
                                                                        data-kt-countup-value="{{ $totalRepayment }}"
                                                                        data-kt-countup-prefix="TZS ">0</div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--begin::Label-->
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="fs-2 fw-bold" data-kt-countup="true"
                                                                        data-kt-countup-value="{{ number_format($customer->credit_score, 2, '.', '') }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                                            <span class="fw-semibold fs-6 text-gray-500">Profile
                                                                Completion</span>
                                                            <span class="fw-bold fs-6">{{ $completionPercent }}%</span>
                                                        </div>
                                ...
                                <div class="row g-5 g-xxl-8">
                                    <!--begin::details View-->
                                    <div class="card mb-3 mb-xxl-2" id="kt_profile_details_view">
                                        <!--begin::Card header-->
                                        ...
                                        <div class="card-body p-9">
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800 me-2">{{ $customer->phone }}</span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">NIDA Number
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Phone number must be active">
                                                        <i class="ki-duotone ki-information fs-7">
                                                            <span class="path1"></span>
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800 me-2">{{ $customer->nida_number }}</span>
                                                    <span class="badge badge-success">Verified</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Credit Score</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <span
                                                        class="fw-semibold text-gray-800 fs-6">{{ $customer->credit_score }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">First Referee Name </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">{{ ucfirst($customer->referee_one_name) }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">First Referee Phone </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">{{ $customer->referee_one_phone }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--begin::Row-->
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Second Referee Name </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">{{ ucfirst($customer->referee_two_name) }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Second Referee Phone
                                                </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">{{ $customer->referee_two_phone }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8">
                                                    <a href="#"
                                                        class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $customer->District }}</a>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8">
                                                    <a href="#"
                                                        class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $customer->Region }}</a>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--begin::Input group-->
    ...
    <!--end::Modals-->
    <!--begin::Javascript-->
    @include('scripts._customer_create_script')
@endsection
