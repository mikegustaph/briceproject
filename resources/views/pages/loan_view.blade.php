                                ...
                                <div class="row g-5 g-xxl-8">
                                    ...
                                    <div class="card mb-3 mb-xxl-2" id="kt_profile_details_view">
                                        ...
                                        <div class="card-header cursor-pointer">
                                            ...
                                            <div class="card-title m-0">
                                                <a href="{{ URL::to('/approve_loan/' . $loan->id) }}"
                                                    class="btn ml-4 btn-sm btn-primary btn-flex btn-center"
                                                    style="margin: 0 10px 0" data-kt-menu-trigger="click"
                                                    data-kt-menu-placement="bottom-end">Approve
                                                </a>

                                                <a href="#" class="btn btn-sm btn-danger ml-4 btn-flex btn-center"
                                                    data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Deny
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-9">
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Customer Name
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800 me-2">{{ ucfirst($loan->customers->first_name ?? null) }}
                                                        {{ ucfirst($loan->customers->last_name ?? null) }}</span>
                                                </div>
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Principal
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Princial amount must be approved">
                                                        <i class="ki-duotone ki-information fs-7">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800 me-2">{{ $loan->principal }}</span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Interest Rate </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <span
                                                        class="fw-semibold text-gray-800 fs-6">{{ $loan->interest_rate }}<span>%</span></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--begin::Row-->
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Service Charge</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800">{{ $loan->service_charge }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Repay Amount </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800">{{ $loan->total_repay }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--begin::Row-->
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8">
                                                    @php
                                                        ...
                                                        $repayDate = $loan->created_at
                                                            ->copy()
                                                            ->addDays($loan->number_of_days); // Calculate repay date

                                                        // Determine loan status
                                                        if ($loan->status == 'paid') {
                                                            $status = 'success';
                                                            $displayStatus = 'Paid';
                                                        } elseif ($today->gt($repayDate)) {
                                                            $status = 'danger';
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="badge badge-{{ $status }}">{{ $displayStatus }}</span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        </div>
