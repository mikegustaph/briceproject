...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Disclosure </h3>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <div class="btn-control" style="padding-left: 10px;">
                        <a type="button" href="{{ route('app.disclosurecreate') }}" class="btn btn-primary btn-fw">Add New
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="template-demo">
                                                    <a href="{{ url('/disclosure_edit/' . $item->id) }}" type="button"
                                                        class="btn btn-primary"><i class="mdi mdi-border-color "></i></a>
                                                    <a href="{{ url('/app/disclosure_delete/' . $item->id) }}"
