                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">New Loan Collection Group</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div id="kt_account_settings_profile_details" class="collapse show">
                                        ...
                                        <form id="kt_account_profile_details_form"
                                            action="{{ url('/add-collection-group') }}" class="form" method="POST"
                                            ...
                                            <div class="card-body p-9">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                        <span class="required">Days Overdue</span>
                                                        <span class="ms-1" data-bs-toggle="tooltip"
                                                            title="Define days overdue">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="text" name="number_days"
                                                            class="form-control form-control-lg form-control-solid"
                                                            placeholder="Days Overdue" required />
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <select class="form-select form-select-solid" name="classification"
                                                            ...
                                                            <option value="Especially"> Especially mentioned </option>
                                                ...
                                                <div class="row mb-6">
                                                    <!--begin::Label-->
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                                        <span class="required">Provision </span>
                                                        <span class="ms-1" data-bs-toggle="tooltip"
                                                            title="Write a provision ">
                                                            <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                                <span class="path1"></span>
                                                                <span class="path2"></span>
                                                                <span class="path3"></span>
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="text" name="provision"
                                                            class="form-control form-control-lg form-control-solid"
                                                            placeholder="Enter a Provision in Percentage" required />
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
