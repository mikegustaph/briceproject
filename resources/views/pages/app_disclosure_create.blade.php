...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Disclosure </h3>
            <div class="col-sm-6">
                @if ($errors->any())
        ...
        <div class="row ">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add Disclosure Statement</h4>
                        <form action="{{ url('/app/disclosure_statement') }}" method="POST" class="forms-sample"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" style="color: white;" name="name" class="form-control"
                                    id="exampleInputName1" placeholder="Name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Text Area</label>
                                <textarea style="color: white;" name="disclosuretext" class="form-control" id="" rows="35" required></textarea>
                            </div>
