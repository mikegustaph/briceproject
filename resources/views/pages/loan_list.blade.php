                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        ...
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_loan_form">Add
                                            New Loan</a>
                                        <!--end::Add product-->
                                    </div>
                                    <!--end::Card toolbar-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <thead>
                                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="text-start min-w-100px">Princial</th>
                                                <th class="text-start min-w-100px">Repay Amount</th>
                                                <th class="text-end min-w-100px">Loan Date</th>
                                                <th class="text-end min-w-100px">Repay Date</th>
                                                <th class="text-end min-w-100px">Terms</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-5">
                                                                <!--begin::Title-->
                                                                <a href="#"
                                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ ucfirst($item->customers->first_name ?? null) }}
                                                                    {{ ucfirst($item->customers->last_name ?? null) }}</a>
                                                                <!--end::Title-->
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-start pe-0">
                                                        <span class="fw-bold">{{ $item->principal }}</span>
                                                    </td>
                                                    <td class="text-start pe-0">
                                                        <span class="fw-bold">{{ $item->total_repay }}</span>
                                                    </td>
                                                    <td class="text-end" data-order="2023-11-18">
                                                        <span
                                                            class="fw-bold">{{ $item->created_at->format('d/m/Y') }}</span>
                                                    </td>
                                                    @php
                                                        $repayDate = $item->created_at
                                                            ->copy()
                                                            ->addDay($item->number_of_days)
                                                            ->format('d/m/Y');
                                                    @endphp
                                                    <td class="text-end" data-order="2023-11-23">
                                                        <span class="fw-bold">{{ $repayDate }}</span>
                                                    </td>
                                                    <td class="text-end" data-order="2023-11-23">
                                                        <span class="fw-bold">{{ $item->number_of_days }}</span>
                                                    </td>
                                                    <td class="text-end pe-0" data-order="Failed">
                                                        @php
                                                            ...
                                                            $repayDate = $item->created_at
                                                                ->copy()
                                                                ->addDays($item->number_of_days); // Calculate repay date
                                                        ...
                                                        @endphp
                                                        <div class="badge badge-light-{{ $status }}">
                                                            {{ $displayStatus }}</div>
                                                    </td>
                                                    <td class="text-end">

                                                        <a href="{{ URL::to('/loan-view/' . ($item->id ?? null)) }}"
