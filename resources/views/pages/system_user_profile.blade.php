                        ...
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="forms-sample" method="POST"
                                            action="{{ url('/system_user_update_1/' . $profile->id) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" value="{{ $profile->first_name }}"
                                                        style="color: white;" name="first_name" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" value="{{ $profile->last_name }}"
                                                        style="color: white;" name="last_name" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{ $profile->email }}" type="email" style="color: white;"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{ $profile->phone }}" type="tel" style="color: white;"
                                                    name="mobile" class="form-control" id="exampleInputMobile"
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="forms-sample" method="POST"
                                            action="{{ url('/system_user_update_2/' . $pass->id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="forms-sample" method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <img src="{{ Storage::url('public/SystemUser/' . $profile->profile_image) }}"
                                                        alt="image" width="149px" height="auto" />
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <a target="_blank"
                                                    href="{{ Storage::url('public/SystemUser/' . $profile->cv) }}"
