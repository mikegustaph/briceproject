                                        ...
                                        <form id="kt_account_profile_details_form" class="form" method="POST"
                                            ...
                                            <div class="card-body p-9">
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="text" name="name"
                                                            ...
                                                            placeholder="Policy Title" value="{{ $policyedit->title }}" />
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8 fv-row">
                                                        <textarea type="text" value="{{ $policyedit->description }}" name="description"
                                                            class="form-control form-control-lg form-control-solid" placeholder="Policy Description"></textarea>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
