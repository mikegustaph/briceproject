...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create About Us </h3>
            <div class="col-sm-6">
                @if ($errors->any())
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/app/about_us_create') }}" method="POST" class="forms-sample"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="color: white;" name="aboutText" class="form-control" id="" rows="35" required></textarea>
                            </div>
