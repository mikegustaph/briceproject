...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add New Support </h3>
            <div class="col-sm-6">
                @if ($errors->any())
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/app/support_create') }}" method="POST" class="forms-sample"
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1"> Support Email</label>
                                <input type="text" style="color: white;" name="supportEmail" class="form-control"
                                    id="exampleInputName1" placeholder="Name" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1"> Support Phone</label>
                                <input type="text" style="color: white;" name="supportPhone" class="form-control"
                                    id="exampleInputName1" placeholder="Name" required>
                            </div>
