...
@section('content')
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Transfer Transactions</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                                            ...
                                            <thead>
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="text-end min-w-100px">External ID</th>
                                                    <th class="text-end min-w-75px">Provider</th>
                                                    <th class="text-end min-w-75px">Status</th>
                                                </tr>
                                            </thead>
                                            <tbody class="fw-semibold text-gray-600">
                                                @foreach ($data as $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-end pe-0">{{ $item->amount }}</td>
                                                        <td class="text-end pe-0">{{ $item->externalId }}</td>
                                                        <td class="text-end pe-0">{{ $item->provider }}</td>
                                                        <td class="text-end">
                                                            @if ($item->status === 'Success')
                                                                <div class="badge badge-light-success">Success</div>
                                                            @elseif ($item->status === 'Initiated')
                                                                <div class="badge badge-light-primary">Initiated</div>
                                                            @else
    ...
    <!--end::Modals-->
    @include('scripts._borrow_script')
@endsection
