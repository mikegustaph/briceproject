            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/app/policy_create') }}" method="POST" class="forms-sample"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="color: white;" name="privacytext" class="form-control" id="" rows="35" required></textarea>
                            </div>
