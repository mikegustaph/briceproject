...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Why Choose Us </h3>
            <div class="col-sm-6">
                @if ($errors->any())
        ...
        <div class="row ">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit New why choose us</h4>
                        <form action="{{ url('/app/whychoose_us_create/' . $result->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $result->title }}" style="color: white;" name="title"
                                    class="form-control" id="exampleInputName1" placeholder="Title">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Interest Rate</label>
                                <input type="text" value="{{ $result->interest_rate }}" style="color: white;"
                                    name="intratext" class="form-control" id="exampleInputName1"
                                    placeholder="Interest Rate">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Service Charge</label>
                                <input type="text" value="{{ $result->service_charge }}" style="color: white;"
                                    name="servCharge" class="form-control" id="exampleInputName1"
