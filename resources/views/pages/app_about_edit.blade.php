            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/app/about_us_edit/' . $result->id) }}" method="POST" class="forms-sample"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $result->title }}" style="color: white;" name="name"
                                    class="form-control" id="exampleInputName1" placeholder="Name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Text Area</label>
                                <textarea style="color: white;" value="{{ $result->about_text }}" name="aboutText" class="form-control" id=""
