                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                ...
                                                <!--end::Export-->
                                                <!--begin::Add customer-->
                                                <a href="{{ URL::to('/task-create') }}" type="button"
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                @foreach ($tasks as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-800 text-hover-primary mb-1">{{ $item->task_name }}</a>
                                                        </td>
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">{{ $item->userAssigned->username }}
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ URL::to('/task-edit/'. $item->id) }}"
                                                                        class="menu-link px-3">Edit</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ URL::to('/task-delete/'.$item->id) }}" class="menu-link px-3"
