            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/task/task_edit') }}" method="POST" class="forms-sample"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="exampleInputName1"> Task Name</label>
                                <input type="text" style="color: white;" value="{{ $task->id }}" name="taskname"
                                    class="form-control" id="exampleInputName1" placeholder="Task name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" style="color: white;" name="tasknote" rows="23" class="form-control"
                                    id="exampleInputName1">{{ $task->task_note }}</textarea>
                            </div>
