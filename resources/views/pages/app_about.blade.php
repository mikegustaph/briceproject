            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <div class="btn-control" style="padding-left: 10px;">
                        <a type="button" href="{{ route('app.aboutuscreate') }}" class="btn btn-primary btn-fw">Add New
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="template-demo">
                                                    <a href="{{ url('/app/about_us_edit/' . $item->id) }}" type="button"
                                                        class="btn btn-primary"><i class="mdi mdi-border-color "></i></a>
                                                    <a href="{{ url('/app/about_us_delete/' . $item->id) }}" type="button"
