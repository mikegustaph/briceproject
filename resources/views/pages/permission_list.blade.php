                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Dashboard </a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Customers</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Transactions</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Borrowing
                                                            History</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Tasks</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Marketing</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Users</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <tr>
                                                    <td class="min-w-125px">
                                                        <a href="apps/customers/view.html"
                                                            class="text-gray-800 text-hover-primary mb-1">Role</a>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="form-check form-check-sm form-check-custom form-check-solid">
